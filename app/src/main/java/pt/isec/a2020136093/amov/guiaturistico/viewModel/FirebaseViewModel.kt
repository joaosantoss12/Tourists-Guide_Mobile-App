...
class FirebaseViewModel : ViewModel() {
    ...
    fun updateLocation_firebase(descricao : String, latitude : String, longitude : String, metodo : String) {
        viewModelScope.launch{
            FirebaseStorageUtil.updateLocation(editName,descricao,imagePath,user.value?.email!!,latitude,longitude,metodo)
        }
    }
    fun updateLocalInteresse_firebase(descricao : String, categoria : String, latitude : String, longitude : String, metodo : String) {
        viewModelScope.launch{
            FirebaseStorageUtil.updateLocalInteresse(editName,descricao,categoria,imagePath,user.value?.email!!,latitude,longitude,metodo)
        }
    }
    fun updateCategoria_firebase(descricao : String) {
        viewModelScope.launch{
            FirebaseStorageUtil.updateCategoria(editName,descricao,imagePath,user.value?.email!!)
        }
    }
